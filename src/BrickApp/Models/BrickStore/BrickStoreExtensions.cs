...
{
    public static class BrickAppExtensions
    {
        public static void EnsureSampleData(this IApplicationBuilder app)
        {
            var context = app.ApplicationServices.GetService<BrickStoreContext>();
            if (context.AllMigrationsApplied())
            {
                ...
                if (!context.WebsiteAds.Any())
                {
                    ...
                    context.WebsiteAds.Add(new WebsiteAd { ImageUrl = "/images/banners/DemoApplication.png", TagLine = "Unicorn Store is a demo application for Entity Framework 7", Details = "See github.com/rowanmiller/BrickApp for details", Url = "http://github.com/rowanmiller/BrickApp" });
